...
object Get:
   ...
   def contramapKeys[F[_], K, B, A](l: Get[F, K, A])(g: B => K): Get[F, B, A] = new Get[F, B, A]:
   ...
   def mapK[F[_], G[_], K, V](g: Get[F, K, V])(fk: F ~> G): Get[G, K, V] = new Get[G, K, V]:
...
object Delete:
   ...
   def mapK[F[_], G[_], K](d: Delete[F, K])(fk: F ~> G): Delete[G, K] = new Delete[G, K]:
...
object Cache:
   def imapValues[F[_]: Functor, K, A, B](
       cache: Cache[F, K, A]
   )(f: A => B, g: B => A): Cache[F, K, B] = new Cache[F, K, B]:
   ...
   def evalIMap[F[_]: Monad, K, V1, V2](
       c: Cache[F, K, V1]
   )(f: V1 => F[V2], g: V2 => V1): Cache[F, K, V2] = new Cache[F, K, V2]:
