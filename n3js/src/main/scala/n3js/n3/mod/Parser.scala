...
//	 def parse(input: String, callback: Unit, prefixCallback: PrefixCallback): js.Array[Q] = js.native
   ...
   // for testing
   var _emit: js.ThisFunction4[Parser, Quad.Subject, Quad.Predicate, Quad.Object, js.UndefOr[
     Quad.Graph
   ], Unit] = js.native
   val _quad
       : js.Function4[Quad.Subject, Quad.Predicate, Quad.Object, js.UndefOr[Quad.Graph], Quad] =
     js.native
...
object Parser:
   ...
   val setCallbacks: js.ThisFunction2[Parser, ParseCallback, PrefixCallback, Unit] =
     (thiz: Parser, quadCallback: ParseCallback, prefixCallback: PrefixCallback) =>
        ...
        val callbackFn: TokenCallback =
          (err: js.UndefOr[js.Error], tok: js.UndefOr[n3js.n3.mod.Token]) =>
            if err != null && err.isDefined then thiz._callback(err, js.undefined, js.undefined)
//					thiz._callback = noopCallback
               ...
               thiz._callback(
                 new js.Error("don't have a callback to continue parsing"),
                 js.undefined,
                 js.undefined
               )
   ...
   val noopCallback: ParseCallback = (
       ...
       pre: js.UndefOr[n3js.n3.mod.Prefixes[NamedNode]]
   ) => ()
