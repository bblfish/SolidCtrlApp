...
// 		 factory.asInstanceOf[js.Any])).asInstanceOf[n3js.n3.mod.Term]
   ...
   @scala.inline
   def termToId(term: n3js.n3.mod.Term): java.lang.String = n3js.n3.mod.^.asInstanceOf[js.Dynamic]
     .applyDynamic("termToId")(term.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
   ...
   type MimeFormat = n3js.n3.mod.MimeSubtype |
     n3js.n3.n3Strings.DollarLeftcurlybracketMimeTypeRightcurlybracketSlashDollarLeftcurlybracketMimeSubtypeRightcurlybracket

   type MimeSubtype = n3js.n3.mod.BaseFormatVariant |
     n3js.n3.n3Strings.DollarLeftcurlybracketBaseFormatVariantRightcurlybracketDollarLeftcurlybracketStarRightcurlybracket
   ...
   type QuadPredicate[Q /* <: n3js.n3.mod.BaseQuad */ ] =
     js.Function1[ /* result */ Q, scala.Boolean]
   ...
   type TokenCallback = js.Function2[ /* error */ js.UndefOr[js.Error], /* token */ js.UndefOr[
       n3js.n3.mod.Token
     ], scala.Unit]
