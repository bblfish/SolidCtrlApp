...
object ParserOptions:
   ...
   implicit class ParserOptionsMutableBuilder[Self <: ParserOptions](val x: Self) extends AnyVal:
      ...
      @scala.inline
      def setBlankNodePrefix(value: String): Self = StObject
        .set(x, "blankNodePrefix", value.asInstanceOf[js.Any])

      @scala.inline
      def setBlankNodePrefixUndefined: Self = StObject.set(x, "blankNodePrefix", js.undefined)

      @scala.inline
      def setFactory(value: run.cosy.rdfjs.model.DataFactory): Self = StObject
        .set(x, "factory", value.asInstanceOf[js.Any])

      @scala.inline
      def setFactoryUndefined: Self = StObject.set(x, "factory", js.undefined)

      @scala.inline
      def setFormat(value: String | MimeFormat): Self = StObject
        .set(x, "format", value.asInstanceOf[js.Any])
