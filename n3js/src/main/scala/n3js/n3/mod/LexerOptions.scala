...
object LexerOptions:
   ...
   implicit class LexerOptionsMutableBuilder[Self <: LexerOptions](val x: Self) extends AnyVal:
      ...
      @scala.inline
      def setComments(value: Boolean): Self = StObject
        .set(x, "comments", value.asInstanceOf[js.Any])

      @scala.inline
      def setCommentsUndefined: Self = StObject.set(x, "comments", js.undefined)

      @scala.inline
      def setLineMode(value: Boolean): Self = StObject
        .set(x, "lineMode", value.asInstanceOf[js.Any])
