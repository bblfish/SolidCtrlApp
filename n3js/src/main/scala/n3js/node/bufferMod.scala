...
import n3js.node.anon.Data
import n3js.node.anon.ToPrimitive
import n3js.node.anon.ValueOf
import n3js.node.bufferMod.global.BufferEncoding
import n3js.node.cryptoMod.BinaryLike
import n3js.node.cryptoMod._KeyLike
import n3js.node.fsMod._EncodingOption
import n3js.node.fsMod._PathLike
import n3js.node.fsMod._WriteFileOptions
import n3js.std.Uint8Array
...
object bufferMod {
  ...
  class Blob protected () extends StObject {
    ...
    /**
      ...
      */
    def slice(): n3js.node.bufferMod.Blob = js.native
    def slice(start: Double): n3js.node.bufferMod.Blob = js.native
    def slice(start: Double, end: Double): n3js.node.bufferMod.Blob = js.native
    def slice(start: Double, end: Double, `type`: String): n3js.node.bufferMod.Blob = js.native
    def slice(start: Double, end: Unit, `type`: String): n3js.node.bufferMod.Blob = js.native
    def slice(start: Unit, end: Double): n3js.node.bufferMod.Blob = js.native
    def slice(start: Unit, end: Double, `type`: String): n3js.node.bufferMod.Blob = js.native
    def slice(start: Unit, end: Unit, `type`: String): n3js.node.bufferMod.Blob = js.native
    
    /**
      * Returns a new `ReadableStream` that allows the content of the `Blob` to be read.
      * @since v16.7.0
      */
    def stream(): js.Any = js.native
  ...
  object global {
    ...
    /**
      ...
      */
    Instantiable1[
              (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ /* arrayBuffer */ js.Any) | (/* array */ js.Array[js.Any]) | (/* arrayBuffer */ js.typedarray.ArrayBuffer) | (/* buffer */ Buffer) | (/* size */ Double) | (/* str */ String) | (/* array */ js.typedarray.Uint8Array), 
              Buffer
            ]
      ...
      def byteLength(
        string: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ js.Any
      ): Double = js.native
      def byteLength(
        string: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ js.Any,
      ...
      def from(
        arrayBuffer: WithImplicitCoercion[
              (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ js.Any) | js.Array[Double] | js.typedarray.ArrayBuffer | String | js.typedarray.Uint8Array
            ]
      ): Buffer = js.native
      def from(
        arrayBuffer: WithImplicitCoercion[
              js.typedarray.ArrayBuffer | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ js.Any)
            ],
        byteOffset: Double
      ): Buffer = js.native
      def from(
    ...
    /* Rewritten from type alias, can be one of: 
      - n3js.node.nodeStrings.ascii
      - n3js.node.nodeStrings.utf8
      - n3js.node.nodeStrings.`utf-8`
      - n3js.node.nodeStrings.utf16le
      - n3js.node.nodeStrings.ucs2
      - n3js.node.nodeStrings.`ucs-2`
      - n3js.node.nodeStrings.base64
      - n3js.node.nodeStrings.base64url
      - n3js.node.nodeStrings.latin1
      - n3js.node.nodeStrings.binary
      - n3js.node.nodeStrings.hex
    */
    ...
    object BufferEncoding {
      ...
      @scala.inline
      def ascii: n3js.node.nodeStrings.ascii = "ascii".asInstanceOf[n3js.node.nodeStrings.ascii]
      
      @scala.inline
      def base64: n3js.node.nodeStrings.base64 = "base64".asInstanceOf[n3js.node.nodeStrings.base64]
      
      @scala.inline
      def base64url: n3js.node.nodeStrings.base64url = "base64url".asInstanceOf[n3js.node.nodeStrings.base64url]
      
      @scala.inline
      def binary: n3js.node.nodeStrings.binary = "binary".asInstanceOf[n3js.node.nodeStrings.binary]
      
      @scala.inline
      def hex: n3js.node.nodeStrings.hex = "hex".asInstanceOf[n3js.node.nodeStrings.hex]
      
      @scala.inline
      def latin1: n3js.node.nodeStrings.latin1 = "latin1".asInstanceOf[n3js.node.nodeStrings.latin1]
      
      @scala.inline
      def `ucs-2`: n3js.node.nodeStrings.`ucs-2` = "ucs-2".asInstanceOf[n3js.node.nodeStrings.`ucs-2`]
      
      @scala.inline
      def ucs2: n3js.node.nodeStrings.ucs2 = "ucs2".asInstanceOf[n3js.node.nodeStrings.ucs2]
      
      @scala.inline
      def `utf-8`: n3js.node.nodeStrings.`utf-8` = "utf-8".asInstanceOf[n3js.node.nodeStrings.`utf-8`]
      
      @scala.inline
      def utf16le: n3js.node.nodeStrings.utf16le = "utf16le".asInstanceOf[n3js.node.nodeStrings.utf16le]
      
      @scala.inline
      def utf8: n3js.node.nodeStrings.utf8 = "utf8".asInstanceOf[n3js.node.nodeStrings.utf8]
    }
