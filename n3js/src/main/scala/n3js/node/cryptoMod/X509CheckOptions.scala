...
import n3js.node.nodeStrings.always
import n3js.node.nodeStrings.never
...
trait X509CheckOptions extends StObject {
  ...
  /**
    * @default false
    */
  var multiLabelWildcards: Boolean = js.native
  
  /**
    * @default true
    */
  var partialWildcards: Boolean = js.native
  
  /**
    * @default false
    */
  var singleLabelSubdomains: Boolean = js.native
  
  /**
    * @default 'always'
    */
  var subject: always | never = js.native
